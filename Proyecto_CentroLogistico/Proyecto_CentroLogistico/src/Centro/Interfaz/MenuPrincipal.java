...
public class MenuPrincipal extends JFrame {
    ...
    private JPanel construirPanelContenido() {
        ...
        panelContenido.add(new PanelInsumos(),           "INSUMOS");
        panelContenido.add(new PanelMedicamentos(),      "MEDICAMENTOS");
        panelContenido.add(new PanelBienesDevolutivos(), "BIENES");
        panelContenido.add(new PanelUbicacion(),         "UBICACIONES");
