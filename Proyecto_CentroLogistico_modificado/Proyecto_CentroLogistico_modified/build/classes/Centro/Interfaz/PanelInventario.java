...
public class PanelInventario extends JPanel {
    ...
    private JPanel construirFormUnificado() {
        ...
        JComponent[] ctrlLote = {txtLote, txtVencimiento, txtExistencias, txtCosto, cmbUbicacion};
    ...
    private void cargarCombos() {
        ...
        cmbUbicacion.addItem(new Ubicacion(0, "Sin asignar"));
    ...
    private boolean hayDatosDeLote() {
        ...
        String venc = txtVencimiento.getText() == null ? "" : txtVencimiento.getText().trim();
