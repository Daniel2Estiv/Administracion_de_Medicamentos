...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal(Usuario usuario) {
        ...
        // Unifica el formato de fechas en BD (ISO → DD/MM/YYYY) una vez al arrancar.
        try { new LoteExistenciaDAO().normalizarFormatoFechas(); } catch (Exception ignored) {}
    ...
    private JPanel construirPanelContenido() {
        ...
        panelContenido.add(new PanelPresentaciones(usuarioActual),     "PRESENTACIONES");
    ...
    private JPanel construirMenuLateral() {
        ...
        menu.add(crearBtnMenu("🏷  Presentaciones",     "PRESENTACIONES"));
    ...
    private JPanel construirDashboard() {
        ...
        JLabel lblAlerta = new JLabel("⚠️  Próximos a vencer (siguientes 30 días) — ordenados por fecha más cercana");
        ...
        // Carga inicial + refresco al volver a Inicio.
        recargarAlertas(tablaAlerta);
        ...
        // Refresca las alertas cada vez que el panel Inicio vuelve a mostrarse,
        // así los productos recién agregados aparecen sin reiniciar la app.
        final javax.swing.JTable tablaAlertaRef = tablaAlerta;
        dash.addComponentListener(new java.awt.event.ComponentAdapter() {
            @Override public void componentShown(java.awt.event.ComponentEvent e) {
                recargarAlertas(tablaAlertaRef);
            }
        });
        return dash;
    }
    ...
    /** (Re)carga las alertas de vencimiento en la tabla del dashboard. */
    private void recargarAlertas(final javax.swing.JTable tablaAlerta) {
        javax.swing.SwingWorker<java.util.List<Object[]>, Void> worker =
                new javax.swing.SwingWorker<>() {
            @Override protected java.util.List<Object[]> doInBackground() {
                // Sólo productos que vencen en los próximos 30 días (1 mes).
                return new LoteExistenciaDAO().alertasVencimientoGlobal(30);
            }
